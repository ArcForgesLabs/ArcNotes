...
public:
    ...
    [[nodiscard]] QSize bufferSizeHint(const QStyleOptionViewItem& option, const QModelIndex& index) const;
    ...
    [[nodiscard]] Theme::Value theme() const;
    void setIsInAllNotes(bool newIsInAllNotes);
    [[nodiscard]] bool isInAllNotes() const;
    void clearSizeMap();
...
public:
    ...
    [[nodiscard]] const QModelIndex& hoveredIndex() const;
    [[nodiscard]] bool shouldPaintSeparator(const QModelIndex& index, const NoteListModel& model) const;
