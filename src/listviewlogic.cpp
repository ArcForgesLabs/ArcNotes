...
ListViewLogic::ListViewLogic(NoteListView* noteView, NoteListModel* noteModel, QLineEdit* searchEdit,
                             QToolButton* clearButton, TagPool* tagPool, DBManager* dbManager, QObject* parent)
    : QObject(parent),
      m_listView{noteView},
    ...
    connect(m_listModel, &NoteListModel::requestUpdatePinnedRelPos, dbManager, &DBManager::updateRelPosPinnedNote,
            Qt::QueuedConnection);
    connect(m_listModel, &NoteListModel::requestUpdatePinnedRelPosAN, dbManager, &DBManager::updateRelPosPinnedNoteAN,
            Qt::QueuedConnection);
    connect(m_listModel, &NoteListModel::requestUpdatePinned, dbManager, &DBManager::setNoteIsPinned,
            Qt::QueuedConnection);
    ...
    connect(this, &ListViewLogic::requestNotesListInFolder, m_dbManager, &DBManager::onNotesListInFolderRequested,
            Qt::QueuedConnection);
    connect(this, &ListViewLogic::requestNotesListInTags, m_dbManager, &DBManager::onNotesListInTagsRequested,
            Qt::QueuedConnection);
