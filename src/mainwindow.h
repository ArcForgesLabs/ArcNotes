...
L_DECLARE_ENUM(SubscriptionStatus, NoSubscription, Active, ActivationLimitReached, Expired, Invalid, EnteredGracePeriod,
               GracePeriodOver, NoInternetConnection, UnknownError)
...
public slots:
    ...
    void setActivationSuccessful(const QString& licenseKey, bool removeGracePeriodStartedDate = true);
...
private slots:
    ...
    void updateFrame();
    [[nodiscard]] bool isTitleBar(int x, int y) const;
