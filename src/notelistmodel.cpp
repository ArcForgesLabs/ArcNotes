...
bool NoteListModel::moveRow(const QModelIndex& sourceParent, int sourceRow, const QModelIndex& destinationParent,
...
NodeData& NoteListModel::getRef(int row) {
    if (row < m_pinnedList.size()) return m_pinnedList[row];
