...
public:
    ...
    [[nodiscard]] bool isPinnedNotesCollapsed() const;
    void setIsPinnedNotesCollapsed(bool newIsPinnedNotesCollapsed);
    void setCurrentIndexC(const QModelIndex& index);
    [[nodiscard]] QModelIndexList getSelectedIndex() const;
    [[nodiscard]] bool isDraggingInsidePinned() const;
...
private:
    ...
    void addNotesToTag(const QSet<int>& notesId, int tagId);
    void removeNotesFromTag(const QSet<int>& notesId, int tagId);
